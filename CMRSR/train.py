...
def main():
    ...
    parser.add_argument('--name', default='train_model', type=str)
    ...
    ## network setting
    parser.add_argument('--net_name', default='Model', type=str, help='RefNet | Baseline')
    ...
    parser.add_argument('--save_folder', default='/data/liuyu/results/weights', type=str)
